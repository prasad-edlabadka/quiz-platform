      ...
      return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center">
          <div className="glass-panel p-8 rounded-2xl max-w-lg w-full border border-red-500/20">
            ...
            <div className={`p-4 rounded-lg text-left text-xs font-mono text-glass-secondary mb-6 overflow-auto max-h-40 ${document.documentElement.classList.contains('dark') ? 'bg-black/30' : 'bg-black/10'}`}>
